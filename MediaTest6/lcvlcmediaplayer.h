#ifndef LCVLCMEDIAPLAYER_H
#define LCVLCMEDIAPLAYER_H
...
class LCVLCMediaPlayer : public QMainWindow
{
    Q_OBJECT

public:
    LCVLCMediaPlayer(QString url, QWidget *parent = nullptr);
    ~LCVLCMediaPlayer();
...
private slots:
    ...
    void Slider_Volume_sliderMoved(int position);

    void on_Slider_Volume_valueChanged(int value);

private:
    Ui::LCVLCMediaPlayer *ui;
